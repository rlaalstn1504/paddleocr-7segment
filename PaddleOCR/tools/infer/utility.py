...
def init_args():
    ...
    # parser.add_argument("--image_dir", type=str, default="/data/str/data/images/")
    parser.add_argument("--page_num", type=int, default=0)
    parser.add_argument("--det_algorithm", type=str, default='DB')
    parser.add_argument("--det_model_dir", type=str, default='./PaddleOCR/output/det_inference')
    ...
    parser.add_argument("--rec_model_dir", type=str, default='./PaddleOCR/output/rec_inference') 
    ...
    parser.add_argument(
        "--rec_char_dict_path",
        type=str,
        default="./PaddleOCR/ppocr/utils/en_dict.txt")
